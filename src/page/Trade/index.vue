  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address) in addressInfo" :key="address.id">
        ...
        <!-- 此处可以不传addressInfo，因为这一个组件，下面计算属性有adderssInfo -->
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(order) in orderInfo.detailArrayList" :key="order.skuid">
          <li>
            <img :src="order.imgUrl" style="width:100px; heigth:100px" alt="">
          </li>
          <li>
            <p>{{ order.skuName }}</p>
            <h4>7天无理由退货</h4>
    ...
    <div class="sub clearFix">
      <!-- <router-link class="subBtn" to="/pay" @click="all">提交订单</router-link> -->
...
export default {
  ...
  computed: {
    ...
    // 将来提交订单处最终选中的地址
    userDefaultAddress() {
      // find:查找数组当中符合条件的元素返回，作为最终结果，返回的是一个对象
      // filter:根据条件返回，返回的是一个新数组
